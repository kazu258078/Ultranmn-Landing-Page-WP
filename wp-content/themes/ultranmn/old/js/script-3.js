 ...
 function shopify_dispaly(){
  ...
  //       ui.createComponent('product', {
  //         id: '5718755344552',
  //         node: document.getElementById('product-component-1600011555178'),
  //         moneyFormat: '%C2%A5%7B%7Bamount_no_decimals%7D%7D',
  //         options: {
  //             "product": {
  //               "styles": {
...
jQuery(document).ready(function() {
    ...
    jQuery("input[type='checkbox']").on("click", function(){
      if(jQuery(this).is(":checked")){
        jQuery("head").append(jQuery(
          '<style id="check-style">' + 
            '.your-checkbox-required::before{ background-color: #FFFFFF }' + 
            '.your-checkbox-required::after{' +
      ...
      jQuery(".shopify-btn").on("click", function(){
        var buy_btn = jQuery("iframe").contents().find(".shopify-buy__btn");
        jQuery('.wpcf7-form').submit();
        buy_btn.trigger("click")
      });

      // jQuery("#product-component-1599108119609").on("click", function(){
      //   jQuery('.wpcf7-form').submit();
      // })
    })
...
function tel_validatoin(tel_1, tel_2, tel_3){
  ...
  if (re.test(tel_validation)) {
      shopify_btn_display(true, true, true)
      // return true
  } else {
